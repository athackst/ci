...
def expected_label(branch: str, patterns):
...
def main():
    ...
    expected = expected_label(branch, patterns)
    ...
    if expected in names:
        print(f"Label '{expected}' is present.")
        return 0

    print(f"Expected label '{expected}' not found. Labels:")
